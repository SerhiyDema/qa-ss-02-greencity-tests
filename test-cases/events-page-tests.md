...
**Testing Object:** Registration Form & Events Page
...
**Title:** Verify that an authorized user can successfully join an event
...
**Title:** Verify restriction of multiple likes/dislikes on an event (Negative Test)
